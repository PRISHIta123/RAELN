...
if dataset=="UNSWNB15":
	...
	if fs_algo=="AE" or fs_algo=="AEL1" or fs_algo=="AEL2" or fs_algo=="AEDropout":
		sf= ae.training(fs_algo,training_features, lr, actf, num_inputs, num_hid, num_output, training_df)
	...
	if class_algo=="RandomForest":
		...
		preds=ladder.training(data,labels,test_data,tlabels,learning_rate,actf1,actf2,layer_sizes,num_labeled,num_samples,num_classes,batch_size)

	elif class_algo=="LadderNWsup":
		preds=ladder_sp.training(data,labels_sp,test_data,tlabels,learning_rate,actf1,actf2,layer_sizes,num_samples,num_classes,batch_size)
