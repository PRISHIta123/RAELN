...
def get_data(training_data, labels, num_samples, batch_size):
        
    idy = np.arange(0, num_samples)
    ...
    return train_dataloader_labelled
...
def training(training_data, labels, testing_data, t_labels, lr, actf1, actf2, layer_sizes, num_samples, num_classes, batch_size=1000):
    ...
    for epoch in range(num_epoch):
        ...
        for batch in range(num_batches):
            ...
            train_dataloader_labelled = get_data(training_data, labels, num_samples, batch_size)
